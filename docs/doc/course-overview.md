...
![编辑课程页面](./course-overview.assets/course-edit-gesture.png)
...
![滑动显示删除操作](./course-overview.assets/course-delete-gesture.png)
...
![ICS 导出成功](./course-overview.assets/ics-succes.png)
...
![允许应用访问系统日历](./course-overview.assets/system-calender-request.png)

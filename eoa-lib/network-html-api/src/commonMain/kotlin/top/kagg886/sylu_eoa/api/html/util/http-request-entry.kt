...
/**
 * Contains [SuspendableHttpRequestRetry] configurations settings.
 *
...
public class HttpRequestRetryConfig {
     ...
     */
    public var modifyRequest: suspend HttpRetryModifyRequestContext.(HttpRequestBuilder) -> Unit = {}
        private set
     ...
     * [Report a problem](https://ktor.io/feedback/?fqname=io.ktor.client.plugins.HttpRequestRetryConfig.modifyRequest)
     */
    public fun modifyRequest(block: suspend HttpRetryModifyRequestContext.(HttpRequestBuilder) -> Unit) {
        modifyRequest = block
    }
     ...
     * Note that, to retry on timeout exceptions, [HttpTimeout] plugin should be installed after [SuspendableHttpRequestRetry].
     *
     * [Report a problem](https://ktor.io/feedback/?fqname=io.ktor.client.plugins.HttpRequestRetryConfig.retryOnExceptionIf)
     */
     ...
     * Note, that in this case, [HttpTimeout] plugin should be installed after [SuspendableHttpRequestRetry].
     *
...
public val SuspendableHttpRequestRetry: ClientPlugin<HttpRequestRetryConfig> = createClientPlugin(
    "RetryFeature",
    ...
    val modifyRequest: suspend HttpRetryModifyRequestContext.(HttpRequestBuilder) -> Unit =
...
/**
 * Configures the [SuspendableHttpRequestRetry] plugin on a per-request level.
 *

...
import top.kagg886.sylu_eoa.api.graduate.EOAGraduateClient
...
class EOARelatedTest {
    companion object {
        internal var client by Delegates.notNull<EOAGraduateClient>()
            private set

        suspend fun beforeAll() = run {
            this@Companion.client = EOAGraduateClient()
            client.init(
                object : Storage {

...
public fun NavHost(
    ...
    dialogHost: @Composable (DialogNavigator) -> Unit = { DialogHost(it) },
...
internal fun NavHost(
    ...
    drawOnBottomEntryDuringAnimation: (@Composable BoxScope.(isBackAnimation: Boolean, progress: Float) -> Unit)?,
